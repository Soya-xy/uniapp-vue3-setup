<template>
  <view  :id="'id_'+readId"  >
	  <slot name="title">
		  <tm-sheet no-level @click="emits('title-click')" :transprent="props.transprent" color="grey-3"   v-if="_title!==''" :height="50" _class="flex flex-col flex-col-center-start"
	  ...
	  <tm-sheet @click="itemClick" color="white" :border="props.showBorder?1:0"  :transprent="props.transprent" borderDirection="bottom" :margin="props.margin" :padding="props.padding">
	      <view :eventPenetrationEnabled="true"  class="flex-1 flex flex-col flex-col-center-start" >
	  		  <slot></slot>
	  	  </view>
	  </tm-sheet>
  </view>
