<template>
	...
	<view>
		<view class="flex flex-row" v-if="_showHeader">
			...
			<view v-if="_fixed.length>0&&defaultProps.showFixed">
				<tm-sheet  :border="_showBottomBorder?1:0" border-direction="bottom" :color="_fixed[0].bgColor" :text="_fixed[0].light"
					...
					>
				    <view  :style="{width:_fixed[0].width-10+'rpx',height:defaultProps.headerHeight-6+'rpx'}" 
			...
			class="flex-1"  :class="['tableHeader']" 
			:scroll-left="headerLeft" 
			:scroll-x="true" 
			:scroll-with-animation="false" 
			:style="{ width: `${defaultProps.width-(defaultProps.showFixed?defaultProps.fixedWidth:0)}rpx` }"
	    ...
	    <view class="flex flex-row">
			...
			<scroll-view class="flex-1" :scroll-with-animation="false" 
			...
			:scroll-top="_fixedmenuTop"
			    :style="[defaultProps.height ? { height: `${defaultProps.height}rpx` } : '', { width: `${defaultProps.width-(defaultProps.showFixed?defaultProps.fixedWidth:0)}rpx` }]">
